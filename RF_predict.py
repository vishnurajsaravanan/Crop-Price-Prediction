...
def pred(district,Crop,Area,soil_type):
    ...
    api_key = "73788eb9caad725858e2396efec65755"    # Use your own API key. You can get it for free from openweathermap
